...
const rmFile = (dir, filename) => {
 // TODO: Remove file here
  // fs.writeFile(argv.dir + dir + filename, data, function(err){console.log(err);});
}


module.exports = {mkProjectDir, mkArchetypeDir, rmArchetypeDir, mkDir, rmDir, writeFile, rmFile  }
